...
import javazoom.jlgui.player.amp.equalizer.ui.Equalizer;
...
import javazoom.jlgui.player.amp.playlist.ui.MP3Files;
...
public class Player extends Window implements ActionListener, BasicPlayerListener, DropTargetListener, WindowListener
{
  ...
  protected static String TITLETEXT = "jlGui 2.3.2 ";
  ...
  protected void loadSkin(SkinLoader skl) throws Exception
  {
	...
	if (equalizer != null) equalizer.dispose();
    System.gc();
	...
	equalizer = new Equalizer(topFrame, this, skl, OrigineX, OrigineY + WinHeight*factor, config.isEqualizerEnabled());
    show();
  }
