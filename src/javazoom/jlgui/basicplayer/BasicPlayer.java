 ...
 * It has been successfully tested under J2SE 1.3.x, 1.4.x and 1.5.0 beta.
 */
...
//	private static Log log = LogFactory.getLog(BasicPlayer.class);
	...
	public boolean hasGainControl()
	{
	  if  (m_gainControl == null)
	  {
		...
		if (m_line.isControlSupported(FloatControl.Type.MASTER_GAIN)) m_gainControl = (FloatControl) m_line.getControl(FloatControl.Type.MASTER_GAIN);
	  }
	...
	public boolean hasPanControl()
	{
	  if (m_panControl == null)
	  {
		...
		if (m_line.isControlSupported(FloatControl.Type.PAN)) m_panControl = (FloatControl) m_line.getControl(FloatControl.Type.PAN);
	  }
